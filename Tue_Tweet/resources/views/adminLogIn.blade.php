...
<head>
    ...
    <div class ="row">
        <div class="col-md-4 col-md-offset-4">
            <h3> Sign Up </h3>
            <form action="{{ route('adminSingup')}}" method="POST">
                <div class="form-group">
                    <label for="email"> Your E-Mail </label>
                    <input class="form-control @error('email') is-invalid @enderror" type="text" name="email" id="email">
                </div>
                <div class="form-group">
                    <label for="adminname"> Your User Name </label>
                    <input class="form-control @error('adminname') is-invalid @enderror" type="text" name="adminname" id="adminname">
                </div>
                <div class="form-group">
