            ...
            <div class="post-container">
                ...
                <div class="post-row">
                    ...
                    <div class="menu-btn-own">
                        <button class="btn btn-dark" type="button" data-bs-toggle="dropdown" aria-expanded="false"><i
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <?php   
                                echo '<li><button type="button" class="dropdown-item" onclick="editTweet(' . $tweet->id . ', ' . htmlspecialchars('"' . $tweetText . '"') . ')" 
                                            data-tweet-id="{{$tweet->id}}" data-bs-toggle="modal" data-bs-target="#EditTweetModal">Edit</button></li>';       
                            ?>
                            <li><button class="dropdown-item">
                                    <a href="{{ route('tweet.hide.feed', ['id' => $tweet->id, 'typ' => htmlspecialchars($tweet->typ)]) }}"
                                        style="text-decoration: none;">Hide/ Unhide Tweet</a>
                                </button></li>
                    ...
                    <div class="comment-post-container">
                        <div class="post-row">
                            ...
                            <div class="menu-btn-own">
                                ...
                                <?php
                                    echo '<li><button type="button" class="dropdown-item" onclick="editComment(' . $comment->comment_id . ', ' . htmlspecialchars('"' . $comment->comment . '"') . ')" 
                                            data-comment-id="{{ $comment->comment_id }}" data-bs-toggle="modal" data-bs-target="#EditCommentModal">Edit</button></li>';
                                ?>
                                </ul>
                            </div>
                            @endif
                    ...
                    <div class="modal-body">
                        <div class="write-post-container">
                            ...
                            <div class="post-input-container">
                                ...
                                <textarea rows="3" placeholder="Add text to your retweet" name="retweet_text"
                                    id="retweet_text"></textarea>
                    ...
                    <div class="modal-body">
                        <div class="write-post-container">
                            ...
                            <div class="post-input-container">
                                ...
                                <textarea rows="3" placeholder="Edit your Retweet" name="editRetweetText"
                                    id="editRetweetText" value="{{ Request::old('retweet_text') }}"></textarea>
                    ...
                    <div class="modal-body">
                        <div class="write-post-container">
                            ...
                            <div class="post-input-container">
                                ...
                                <textarea rows="3" placeholder="Edit your Comment" name="editCommentText"
                                    id="editCommentText" value="{{ Request::old('comment') }}"></textarea>
                                {{-- <div id="pictureCommentEditBox"></div>
                                    <div class="add-post-links">
                                        <a href="#"><i class="fa-solid fa-camera fa-2xl"></i></a>
                                        <div class="form-group">
